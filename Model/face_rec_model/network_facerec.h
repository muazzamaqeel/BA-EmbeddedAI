/**
  ...
  ******************************************************************************
  */
#ifndef AI_NETWORK_FACEREC_H
#define AI_NETWORK_FACEREC_H

#include "network_facerec_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_NETWORK_FACEREC_MODEL_NAME          "network_facerec"
#define AI_NETWORK_FACEREC_ORIGIN_MODEL_NAME   "mobilefacenet_arcface_112x112"

/******************************************************************************/
#define AI_NETWORK_FACEREC_ACTIVATIONS_ALIGNMENT   (4)
#define AI_NETWORK_FACEREC_INPUTS_IN_ACTIVATIONS   (4)
#define AI_NETWORK_FACEREC_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_NETWORK_FACEREC_IN_NUM        (1)

AI_DEPRECATED
#define AI_NETWORK_FACEREC_IN \
  ai_network_facerec_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_FACEREC_IN_SIZE { \
  AI_NETWORK_FACEREC_IN_1_SIZE, \
}
#define AI_NETWORK_FACEREC_IN_SIZE_BYTES { \
  AI_NETWORK_FACEREC_IN_1_SIZE_BYTES, \
}
#define AI_NETWORK_FACEREC_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_NETWORK_FACEREC_IN_1_HEIGHT      (112)
#define AI_NETWORK_FACEREC_IN_1_WIDTH       (112)
#define AI_NETWORK_FACEREC_IN_1_CHANNEL     (3)
#define AI_NETWORK_FACEREC_IN_1_SIZE        (37632)
#define AI_NETWORK_FACEREC_IN_1_SIZE_BYTES  (150528)

/******************************************************************************/
#define AI_NETWORK_FACEREC_OUT_NUM       (1)

AI_DEPRECATED
#define AI_NETWORK_FACEREC_OUT \
  ai_network_facerec_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_FACEREC_OUT_SIZE { \
  AI_NETWORK_FACEREC_OUT_1_SIZE, \
}
#define AI_NETWORK_FACEREC_OUT_SIZE_BYTES { \
  AI_NETWORK_FACEREC_OUT_1_SIZE_BYTES, \
}
#define AI_NETWORK_FACEREC_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_NETWORK_FACEREC_OUT_1_CHANNEL     (512)
#define AI_NETWORK_FACEREC_OUT_1_SIZE        (512)
#define AI_NETWORK_FACEREC_OUT_1_SIZE_BYTES  (2048)

/******************************************************************************/
#define AI_NETWORK_FACEREC_N_NODES (156)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup network_facerec
 ...
 * @ref ai_network_facerec_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_facerec_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_facerec_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_facerec_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_NETWORK_FACEREC_*
 * defines into file @ref network_facerec.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_facerec_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_NETWORK_FACEREC_H */
