...
%% Load this if using the two-column nomenclature format, \begin{nomenclature*}
	...
	%% --- Custom math packages and macros ---
	\usepackage{bm} % bold math symbols
	
	\newcommand*{\Jpsi}{\ensuremath{\bm{J}/\bm{\psi}}}
	\newcommand*{\boldA}{\mathbf{A}} 
	\newcommand*{\boldomega}{\bm{\omega}}
	\AtBeginDocument{%
		\hypersetup{
			linkcolor=black,   % section/page numbers in ToC and cross-references
			citecolor=black,   % citations
			urlcolor=violet,   % keep urls violet (or make black if you prefer)
	...
	\begin{document}
		...
		\title{Bachelor Thesis\\[3ex]Embedded AI Face Recognition with a Focus on Power Optimization Secure Deployment and System Performance}
